...
<div id="search-box"><input type="text" id="search-input" placeholder="Search channels..."></div>
...
<div class="main-layout"><main class="main-content"><section id="channels-section"><h2 class="section-title"><span class="st-bar"></span>Live Channels<span class="st-count" id="ch-count"></span></h2><div class="cat-filter" id="cat-filter"></div><div class="channels-grid" id="channels-grid"></div></section><section id="upcoming-section" style="margin-top:40px"><h2 class="section-title"><span class="st-bar"></span>Coming Up</h2><div class="upcoming-scroll" id="upcoming-scroll"></div></section></main><aside class="sidebar"><div class="sidebar-section"><div class="sidebar-toggle" id="on-air-toggle"><h3><i class="fas fa-broadcast-tower"></i>On Air Now</h3><i class="fas fa-chevron-down chevron"></i></div><div class="sidebar-body" id="on-air-body"></div></div><div class="sidebar-section"><div class="sidebar-toggle" id="trending-toggle"><h3><i class="fas fa-fire"></i>Trending</h3><i class="fas fa-chevron-down chevron"></i></div><div class="sidebar-body" id="trending-body"></div></div><div class="sidebar-section"><div class="sidebar-toggle" id="mistral-toggle"><h3><i class="fas fa-robot"></i>AI Assistant</h3><i class="fas fa-chevron-down chevron"></i></div><div class="sidebar-body" id="mistral-body"><div class="mp-chat"><div class="mp-msg" id="mistral-msg">Ask me about channels!</div><div class="mp-input-wrap"><input class="mp-input" id="mistral-input" placeholder="Ask about channels..."><button class="mp-send" id="mistral-send"><i class="fas fa-paper-plane"></i></button></div></div></div></div></aside></div>
<div id="player-modal"><div class="player-wrap"><button class="player-close" id="player-close"><i class="fas fa-times"></i></button><video id="hls-video" muted playsinline></video><div class="player-spinner" id="player-spinner"><div class="spinner-ring"></div></div><div class="buffering-overlay" id="buffering-overlay"><div class="buffer-pulse"></div></div><div class="offline-overlay" id="offline-overlay"><i class="fas fa-signal off-icon"></i><div class="off-text">STREAM OFFLINE</div><div class="off-hint">This stream may be geo-blocked. Try another channel or use a VPN.</div><button class="btn-retry" id="btn-retry"><i class="fas fa-redo"></i> Retry</button><button class="btn-switch" id="btn-switch"><i class="fas fa-exchange-alt"></i> Try Next Channel</button></div><div class="player-bar"><button id="play-pause"><i class="fas fa-play"></i></button><button id="vol-btn"><i class="fas fa-volume-mute"></i></button><input type="range" id="vol-slider" min="0" max="100" value="0" class="vol-slider"><span class="p-title" id="player-title">-</span><span class="p-quality" id="quality-indicator">HD</span><span class="p-status connecting" id="player-status">CONNECTING</span><button id="audio-btn"><i class="fas fa-headphones"></i></button><button id="fullscreen-btn"><i class="fas fa-expand"></i></button></div></div></div>
<div class="toast" id="toast"></div>
<footer><div class="f-brand">EDGE <span>v5.0</span> &mdash; 100% Free IPTV</div><div class="f-stats"><div class="stat"><strong id="stat-ch">121</strong> channels</div><div class="stat"><strong id="stat-hd">75</strong> HD</div><div class="stat"><strong>10</strong> categories</div></div></footer>
<script>
...
'use strict';
var CHANNELS=[
{id:1,n:"Al Jazeera English",s:"https://live-hls-apps-aje-fa.getaj.net/AJE/index.m3u8",c:"news",q:"1080p",src:"Al Jazeera",v:10492,d:"Global news from the Middle East",clr:"#fa9000",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Aljazeera_eng.svg/960px-Aljazeera_eng.svg.png"},
{id:2,n:"Al Jazeera Arabic",s:"https://live-hls-apps-aja-fa.getaj.net/AJA/01.m3u8",c:"news",q:"1080p",src:"Al Jazeera",v:13631,d:"Arabic-language 24h news",clr:"#fa9000",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Aljazeera_eng.svg/960px-Aljazeera_eng.svg.png"},
{id:3,n:"France 24 English",s:"https://live.france24.com/hls/live/2037218-b/F24_EN_HI_HLS/master_5000.m3u8",c:"news",q:"1080p",src:"France 24",v:12298,d:"International news from Paris",clr:"#0055a5",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/France_24_logo_2023.svg/960px-France_24_logo_2023.svg.png"},
{id:4,n:"France 24 French",s:"https://live.france24.com/hls/live/2037179-b/F24_FR_HI_HLS/master_5000.m3u8",c:"news",q:"1080p",src:"France 24",v:14869,d:"Actualites en francais",clr:"#0055a5",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/France_24_logo_2023.svg/960px-France_24_logo_2023.svg.png"},
{id:5,n:"France 24 Arabic",s:"https://live.france24.com/hls/live/2037222-b/F24_AR_HI_HLS/master_5000.m3u8",c:"news",q:"1080p",src:"France 24",v:7713,d:"Arabic French news",clr:"#0055a5",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/France_24_logo_2023.svg/960px-France_24_logo_2023.svg.png"},
{id:6,n:"DW English",s:"https://dwamdstream102.akamaized.net/hls/live/2015525/dwstream102/master.m3u8",c:"news",q:"1080p",src:"Deutsche Welle",v:6034,d:"Germany international broadcaster",clr:"#003399",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Deutsche_Welle_symbol_2012.svg/960px-Deutsche_Welle_symbol_2012.svg.png"},
{id:7,n:"DW Spanish",s:"https://dwamdstream104.akamaized.net/hls/live/2015530/dwstream104/master.m3u8",c:"news",q:"1080p",src:"Deutsche Welle",v:793,d:"DW en espanol",clr:"#003399",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/8/81/Deutsche_Welle_symbol_2012.svg/960px-Deutsche_Welle_symbol_2012.svg.png"},
{id:8,n:"ABC News Live",s:"https://abc-news-dmd-streams-1.akamaized.net/out/v1/701126012d044971b3fa89406a440133/index.m3u8",c:"news",q:"720p",src:"ABC News",v:10380,d:"24/7 live news from ABC",clr:"#e4002b",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/6/63/ABC_News_Live_logo_2021.svg/960px-ABC_News_Live_logo_2021.svg.png"},
{id:9,n:"ABC News Stream 1",s:"https://abcnews-streams.akamaized.net/hls/live/2023560/abcnewshudson1/master_4000.m3u8",c:"news",q:"720p",src:"ABC News",v:8200,d:"ABC News live stream",clr:"#e4002b",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/6/63/ABC_News_Live_logo_2021.svg/960px-ABC_News_Live_logo_2021.svg.png"},
{id:10,n:"Africa 24",s:"https://africa24.vedge.infomaniak.com/livecast/ik:africa24/manifest.m3u8",c:"news",q:"1080p",src:"Infomaniak",v:2469,d:"Pan-African news",clr:"#007a3d",logo:"https://africa24tv.com/wp-content/uploads/2021/09/logo.png"},
{id:11,n:"Euronews English",s:"https://d35j504z0x2vu2.cloudfront.net/v1/master/0bc8e8376bd8417a1b6761138aa41c26c7309312/euronews/euronews-en.m3u8",c:"news",q:"720p",src:"Euronews",v:6721,d:"European world news",clr:"#003876",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Euronews_2016.svg/960px-Euronews_2016.svg.png"},
{id:12,n:"Court TV",s:"https://cdn-uw2-prod.tsv2.amagi.tv/linear/amg01438-ewscrippscompan-courttv-tablo/playlist.m3u8",c:"news",q:"1080p",src:"Stirr",v:13660,d:"Live trial coverage",clr:"#1a3a5c",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Court_TV_2019.svg/960px-Court_TV_2019.svg.png"},
{id:13,n:"ACCDN",s:"https://raycom-accdn-firetv.amagi.tv/playlist.m3u8",c:"sports",q:"1080p",src:"Amagi",v:9995,d:"ACC Digital Network",clr:"#003087",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/ACC_Network_logo.svg/960px-ACC_Network_logo.svg.png"},
{id:14,n:"CBS Sports Golazo",s:"https://proped3fhg87.airspace-cdn.cbsivideo.com/golazo-live-dai/master/golazo-live-dai.m3u8",c:"sports",q:"720p",src:"CBS",v:8200,d:"24/7 soccer network",clr:"#0047ab",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/CBS_Sports_Golazo_Network_logo.svg/960px-CBS_Sports_Golazo_Network_logo.svg.png"},
{id:15,n:"FIFA+ English",s:"https://a62dad94.wurl.com/master/f36d25e7e52f1ba8d7e56eb859c636563214f541/UmFrdXRlblRWLWV1X0ZJRkFQbHVzRW5nbGlzaF9ITFM/playlist.m3u8",c:"sports",q:"720p",src:"FIFA+",v:7100,d:"FIFA content English",clr:"#326295",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/FIFA%2B_(2025).svg/960px-FIFA%2B_(2025).svg.png"},
{id:16,n:"FIFA+ Spanish",s:"https://6c849fb3.wurl.com/master/f36d25e7e52f1ba8d7e56eb859c636563214f541/TEctbXhfRklGQVBsdXNTcGFuaXNoLTFfS0xT/playlist.m3u8",c:"sports",q:"720p",src:"FIFA+",v:5200,d:"FIFA en espanol",clr:"#326295",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/9/9c/FIFA%2B_(2025).svg/960px-FIFA%2B_(2025).svg.png"},
{id:17,n:"fubo Sports",s:"https://dnf08l6u6uxnz.cloudfront.net/master.m3u8",c:"sports",q:"1080p",src:"fuboTV",v:11400,d:"Free sports network",clr:"#6c2dc7",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/8/8e/FuboTV.svg/960px-FuboTV.svg.png"},
{id:18,n:"Billiard TV",s:"https://1621590671.rsc.cdn77.org/HLS/BILLIARDTV.m3u8",c:"sports",q:"1080p",src:"CDN77",v:6314,d:"24/7 billiards",clr:"#1b5e20",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/Cue_sports_pictogram.svg/960px-Cue_sports_pictogram.svg.png"},
{id:19,n:"FTF Sports",s:"https://1657061170.rsc.cdn77.org/HLS/FTF-LINEAR.m3u8",c:"sports",q:"720p",src:"CDN77",v:4400,d:"Football combat sports",clr:"#b71c1c",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Football_pictogram.svg/960px-Football_pictogram.svg.png"},
{id:20,n:"FanDuel Racing",s:"https://d3ehq1uaxory6w.cloudfront.net/out/v1/35c05f080f4e49a4b4eb031b5a14e505/TVG2index_2.m3u8",c:"sports",q:"720p",src:"FanDuel",v:3500,d:"Live horse racing",clr:"#1493ff",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/FanDuel_logo.svg/960px-FanDuel_logo.svg.png"},
{id:21,n:"FanDuel TV",s:"https://d2jl8r92tdc3f1.cloudfront.net/out/v1/59419700344b4625b7cb0693ba265ea3/TVGindex_1.m3u8",c:"sports",q:"720p",src:"FanDuel",v:4100,d:"Sports betting analysis",clr:"#1493ff",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/FanDuel_logo.svg/960px-FanDuel_logo.svg.png"},
{id:22,n:"DAZN Combat",s:"https://dazn-combat-rakuten.amagi.tv/hls/amagi_hls_data_rakutenAA-dazn-combat-rakuten/CDN/master.m3u8",c:"sports",q:"1080p",src:"Rakuten",v:8600,d:"Combat sports 24/7",clr:"#333",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/DAZN_logo.svg/960px-DAZN_logo.svg.png"},
{id:23,n:"GLORY Kickboxing",s:"https://6f972d29.wurl.com/master/f36d25e7e52f1ba8d7e56eb859c636563214f541/UmFrdXRlblRWLWV1X0dsb3J5S2lja2JveGluZ19ITFM/playlist.m3u8",c:"sports",q:"720p",src:"Rakuten",v:3700,d:"World kickboxing",clr:"#dc143c",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/GLORY_logo.svg/960px-GLORY_logo.svg.png"},
{id:24,n:"Speed Sport 1",s:"https://linear-599.frequency.stream/dist/stirr/599/hls/master/playlist.m3u8",c:"sports",q:"1080p",src:"Stirr",v:5400,d:"Motorsport racing",clr:"#ff6600",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Auto_racing_pictogram.svg/960px-Auto_racing_pictogram.svg.png"},
{id:25,n:"Artflix Classics",s:"https://amogonetworx-artflix-1-nl.samsung.wurl.tv/playlist.m3u8",c:"movies",q:"720p",src:"Samsung TV+",v:5800,d:"Classic cinema golden age",clr:"#8d6e63",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Samsung_TV_Plus_logo.svg/960px-Samsung_TV_Plus_logo.svg.png"},
{id:26,n:"Alien Nation DUST",s:"https://dqi7ayt2o24fn.cloudfront.net/playlist.m3u8",c:"movies",q:"1080p",src:"DUST",v:2479,d:"Sci-fi short films",clr:"#4a148c",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/0/0f/Dust_short_film_logo.svg/960px-Dust_short_film_logo.svg.png"},
{id:27,n:"24h Free Movies",s:"https://d1b5mlajbmvkjv.cloudfront.net/v1/master/9d062541f2ff39b5c0f48b743c6411d25f62fc25/UDU-DistroTV/145.m3u8",c:"movies",q:"720p",src:"DistroTV",v:7800,d:"Free movies 24/7",clr:"#37474f",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Distro_TV_logo.svg/960px-Distro_TV_logo.svg.png"},
{id:28,n:"Rakuten Action",s:"https://284824cf70404fdfb6ddf9349009c710.mediatailor.eu-west-1.amazonaws.com/v1/master/0547f18649bd788bec7b67b746e47670f558b6b2/production-LiveChannel-6066/master.m3u8",c:"movies",q:"1080p",src:"Rakuten",v:12246,d:"Action movies 24/7",clr:"#d32f2f",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Rakuten_TV_logo.svg/960px-Rakuten_TV_logo.svg.png"},
{id:29,n:"Rakuten Top UK",s:"https://0145451975a64b35866170fd2e8fa486.mediatailor.eu-west-1.amazonaws.com/v1/master/0547f18649bd788bec7b67b746e47670f558b6b2/production-LiveChannel-5987/master.m3u8",c:"movies",q:"1080p",src:"Rakuten",v:9466,d:"Top UK movies",clr:"#1565c0",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Rakuten_TV_logo.svg/960px-Rakuten_TV_logo.svg.png"},
{id:30,n:"Charge! Action",s:"https://fast-channels.sinclairstoryline.com/CHARGE/index.m3u8",c:"movies",q:"1080p",src:"Sinclair",v:10663,d:"Action movies series",clr:"#c62828",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/Charge%21_TV_logo.svg/960px-Charge%21_TV_logo.svg.png"},
{id:31,n:"AMC Reality",s:"https://amc-absolutereality-1-us.plex.wurl.tv/playlist.m3u8",c:"entertainment",q:"720p",src:"Plex TV",v:7100,d:"Reality TV from AMC",clr:"#5d4037",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/AMC_Networks_2024.svg/960px-AMC_Networks_2024.svg.png"},
{id:32,n:"ALLBLK Gems",s:"https://df1zke3zj042m.cloudfront.net/playlist.m3u8",c:"entertainment",q:"720p",src:"ALLBLK",v:4200,d:"Black culture entertainment",clr:"#4a148c",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/0/05/ALLBLK_logo.svg/960px-ALLBLK_logo.svg.png"},
{id:33,n:"Bounce XL",s:"https://cdn-uw2-prod.tsv2.amagi.tv/linear/amg01438-ewscrippscompan-bouncexl-tablo/playlist.m3u8",c:"entertainment",q:"1080p",src:"Stirr",v:6800,d:"African-American entertainment",clr:"#ff6f00",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/2/29/Bounce_TV_logo.svg/960px-Bounce_TV_logo.svg.png"},
{id:34,n:"Buzzr Game Shows",s:"https://buzzrota-ono.amagi.tv/playlist.m3u8",c:"entertainment",q:"1080p",src:"Amagi",v:9100,d:"Classic game shows 24/7",clr:"#ff9800",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/d/d6/Buzzr_logo.svg/960px-Buzzr_logo.svg.png"},
{id:35,n:"AsianCrush",s:"https://linear-900.frequency.stream/dist/cineverse/900/hls/master/playlist.m3u8",c:"entertainment",q:"1080p",src:"Frequency",v:5400,d:"Asian movies dramas",clr:"#e91e63",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/9/9f/AsianCrush_logo.svg/960px-AsianCrush_logo.svg.png"},
{id:36,n:"AfroLandTV",s:"https://alt-al.otteravision.com/alt/al/al.m3u8",c:"entertainment",q:"1080p",src:"AfroLand",v:3800,d:"African entertainment",clr:"#1b5e20",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/7/70/AfroLandTV_logo.svg/960px-AfroLandTV_logo.svg.png"},
{id:37,n:"30A Television",s:"https://30a-tv.com/feeds/masters/30atv.m3u8",c:"entertainment",q:"720p",src:"30A TV",v:2900,d:"Florida beach lifestyle",clr:"#00838f",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Samsung_TV_Plus_logo.svg/960px-Samsung_TV_Plus_logo.svg.png"},
{id:38,n:"Forensic Files",s:"https://jmp2.uk/plu-5bb1af6a268cae539bcedb0a.m3u8",c:"entertainment",q:"720p",src:"Pluto TV",v:8300,d:"Crime investigations",clr:"#455a64",logo:"https://images.pluto.tv/channels/5bb1af6a268cae539bcedb0a/colorLogoPNG.png"},
{id:39,n:"CMC California",s:"https://cmc-ono.amagi.tv/playlist.m3u8",c:"music",q:"1080p",src:"Amagi",v:6126,d:"California Music Channel",clr:"#e91e63",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/e/ef/CMC_Music_Channel_logo.svg/960px-CMC_Music_Channel_logo.svg.png"},
{id:40,n:"30A Music",s:"https://30a-tv.com/music.m3u8",c:"music",q:"720p",src:"30A TV",v:2100,d:"Beach music vibes",clr:"#00bcd4",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Samsung_TV_Plus_logo.svg/960px-Samsung_TV_Plus_logo.svg.png"},
{id:41,n:"Dance Television",s:"https://m1b2.worldcast.tv/dancetelevisionone/dancetelevisionone.m3u8",c:"music",q:"1080p",src:"WorldCast",v:4300,d:"Electronic dance music",clr:"#7c4dff",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/b/b7/Dance_Television_logo.png/960px-Dance_Television_logo.png"},
{id:42,n:"DanceTV EDM",s:"https://mbit1.worldcast.tv/dancetelevisionseven/multibit.m3u8",c:"music",q:"1080p",src:"WorldCast",v:3800,d:"Mainstage EDM live",clr:"#651fff",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/b/b7/Dance_Television_logo.png/960px-Dance_Television_logo.png"},
{id:43,n:"DanceTV Techno",s:"https://m2b2.worldcast.tv:7443/dancetelevisionthree/dancetelevisionthree.m3u8",c:"music",q:"1080p",src:"WorldCast",v:2900,d:"Underground techno",clr:"#311b92",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/b/b7/Dance_Television_logo.png/960px-Dance_Television_logo.png"},
{id:44,n:"Clubbing TV",s:"https://d1j2csarxnwazk.cloudfront.net/v1/master/3722c60a815c199d9c0ef36c5b73da68a62b09d1/cc-uze1m6xh4fiyr-ssai-prd/master.m3u8",c:"music",q:"720p",src:"Rakuten",v:5100,d:"Club DJ music",clr:"#9c27b0",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/a/a2/Clubbing_TV_logo.svg/960px-Clubbing_TV_logo.svg.png"},
{id:45,n:"Stingray Rock",s:"https://lotus.stingray.com/manifest/ose-101ads-montreal/samsungtvplus/master.m3u8",c:"music",q:"1080p",src:"Samsung TV+",v:7200,d:"Classic rock hits",clr:"#f44336",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/9/98/Stingray_Music_logo.svg/960px-Stingray_Music_logo.svg.png"},
{id:46,n:"Stingray Hit List",s:"https://lotus.stingray.com/manifest/ose-107ads-montreal/samsungtvplus/master.m3u8",c:"music",q:"1080p",src:"Samsung TV+",v:10903,d:"Today biggest hits",clr:"#ff5722",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/9/98/Stingray_Music_logo.svg/960px-Stingray_Music_logo.svg.png"},
{id:47,n:"BBC Kids",s:"https://dmr1h4skdal9h.cloudfront.net/playlist.m3u8",c:"kids",q:"720p",src:"BBC",v:2721,d:"Children BBC programming",clr:"#00897b",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/CBBC_2016.svg/960px-CBBC_2016.svg.png"},
{id:48,n:"Baby Shark TV",s:"https://newidco-babysharktv-1-us.roku.wurl.tv/playlist.m3u8",c:"kids",q:"1080p",src:"Roku",v:3477,d:"Baby Shark friends",clr:"#ff9800",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/9/96/Baby_Shark%27s_Big_Show_logo.svg/960px-Baby_Shark%27s_Big_Show_logo.svg.png"},
{id:49,n:"Brat TV",s:"https://streams2.sofast.tv/v1/master/611d79b11b77e2f571934fd80ca1413453772ac7/04072b68-dc6a-4d5e-98af-f356ba8d5063/playlist.m3u8",c:"kids",q:"720p",src:"SoFast",v:4398,d:"Gen Z entertainment",clr:"#e040fb",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/d/d4/Brat_TV_logo.svg/960px-Brat_TV_logo.svg.png"},
{id:50,n:"Camp Spoopy",s:"https://stream.ads.ottera.tv/playlist.m3u8?network_id=269",c:"kids",q:"576p",src:"Ottera",v:1800,d:"Spooky fun kids",clr:"#4a148c",logo:"https://img2.static-ottera.com/prod/tg/linear_channel/logo/640x360/camp-spoopy-2021_1920-x-1080_option-5.jpg"},
{id:51,n:"Avatar Pluto",s:"https://jmp2.uk/plu-600adbdf8c554e00072125c9.m3u8",c:"kids",q:"720p",src:"Pluto TV",v:6700,d:"Avatar Nickelodeon",clr:"#00897b",logo:"https://images.pluto.tv/channels/600adbdf8c554e00072125c9/colorLogoPNG.png"},
{id:52,n:"Anime Vision",s:"https://d1ujfw1zyymzyd.cloudfront.net/v1/master/3722c60a815c199d9c0ef36c5b73da68a62b09d1/cc-a6fukwkbxmex8/live/fast-channel-animevision-64527ec0/fast-channel-animevision-64527ec0.m3u8",c:"kids",q:"1080p",src:"Cineverse",v:3603,d:"Anime streaming 24/7",clr:"#e91e63",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/9/9e/Anime_Network_logo.svg/960px-Anime_Network_logo.svg.png"},
{id:53,n:"Documentary+",s:"https://ef79b15c8c7c46c7a9de9d33001dbd07.mediatailor.us-west-2.amazonaws.com/v1/master/ba62fe743df0fe93366eba3a257d792884136c7f/LINEAR-859-DOCUMENTARYPLUS-DOCUMENTARYPLUS/mt/documentaryplus/859/hls/master/playlist.m3u8",c:"documentary",q:"1080p",src:"Amazon",v:7800,d:"Award-winning docs",clr:"#1b5e20",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/9/9a/Documentary%2B_logo.svg/960px-Documentary%2B_logo.svg.png"},
{id:54,n:"Docurama",s:"https://docurama-plex-ingest.cinedigm.com/playlist.m3u8",c:"documentary",q:"1080p",src:"Plex TV",v:4600,d:"Curated documentary films",clr:"#0d47a1",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/5/5e/Docurama_logo.svg/960px-Docurama_logo.svg.png"},
{id:55,n:"DangerTV",s:"https://dk0n7jh428tzj.cloudfront.net/v1/dangertv/samsungheadend_us/latest/main/hls/playlist.m3u8",c:"documentary",q:"720p",src:"Samsung TV+",v:3200,d:"Extreme adventure",clr:"#b71c1c",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Samsung_TV_Plus_logo.svg/960px-Samsung_TV_Plus_logo.svg.png"},
{id:56,n:"Curiosity NOW",s:"https://amg00170-amg00170c4-samsung-gb-4232.playouts.now.amagi.tv/playlist.m3u8",c:"documentary",q:"1080p",src:"Samsung TV+",v:5100,d:"Science nature docs",clr:"#0277bd",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/5/5c/CuriosityStream_logo.svg/960px-CuriosityStream_logo.svg.png"},
{id:57,n:"4K Travel TV",s:"https://d35j504z0x2vu2.cloudfront.net/v1/master/0bc8e8376bd8417a1b6761138aa41c26c7309312/4k-travel-tv/manifest.m3u8",c:"documentary",q:"1080p",src:"DistroTV",v:4900,d:"Travel world in 4K",clr:"#00695c",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Distro_TV_logo.svg/960px-Distro_TV_logo.svg.png"},
{id:58,n:"5-Minute Craft",s:"https://soul-5mincrafteng-rakuten.amagi.tv/playlist.m3u8",c:"documentary",q:"1080p",src:"Rakuten",v:12145,d:"DIY craft videos",clr:"#ff6f00",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/Rakuten_TV_logo.svg/960px-Rakuten_TV_logo.svg.png"},
{id:59,n:"Bloomberg TV",s:"https://d35j504z0x2vu2.cloudfront.net/v1/master/0bc8e8376bd8417a1b6761138aa41c26c7309312/bloomberg-television/bloombergtv.m3u8",c:"international",q:"1080p",src:"Bloomberg",v:11414,d:"Global business finance",clr:"#5c068c",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Bloomberg_L.P._Logo.svg/960px-Bloomberg_L.P._Logo.svg.png"},
{id:60,n:"BBC Earth",s:"https://amg00793-amg00793c6-xumo-us-2669.playouts.now.amagi.tv/BBCStudios-BBCEarthA-hls/playlist.m3u8",c:"international",q:"1080p",src:"Xumo",v:10718,d:"Nature science BBC",clr:"#2e7d32",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/3c/BBC_Earth_2023.svg/960px-BBC_Earth_2023.svg.png"},
{id:61,n:"BBC Top Gear",s:"https://amg00793-amg00793c5-xumo-us-2664.playouts.now.amagi.tv/bbcstudios-bbctopgear8min-all/playlist.m3u8",c:"international",q:"1080p",src:"Xumo",v:7734,d:"Top Gear highlights",clr:"#c62828",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/TopGearLogo.svg/960px-TopGearLogo.svg.png"},
{id:62,n:"Alhurra Iraq",s:"https://mbn-ingest-worldsafe.akamaized.net/hls/live/2038899/MBN_Iraq_Worldsafe_HLS/master.m3u8",c:"international",q:"720p",src:"MBN",v:3400,d:"Iraqi news programming",clr:"#1565c0",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/5/5e/Alhurra_TV_logo.svg/960px-Alhurra_TV_logo.svg.png"},
{id:63,n:"ABC 5 St Paul",s:"https://amg01942-amg01942c2-stirr-us-10173.playouts.now.amagi.tv/playlist.m3u8",c:"international",q:"1080p",src:"Stirr",v:2200,d:"Local ABC Minneapolis",clr:"#e4002b",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/6/63/ABC_News_Live_logo_2021.svg/960px-ABC_News_Live_logo_2021.svg.png"},
{id:64,n:"AccuWeather NOW",s:"https://cdn-ue1-prod.tsv2.amagi.tv/linear/amg00684-accuweather-accuweather-plex/playlist.m3u8",c:"international",q:"1080p",src:"Plex TV",v:6100,d:"24/7 weather forecasts",clr:"#0277bd",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/d/d3/AccuWeather_logo.svg/960px-AccuWeather_logo.svg.png"},
{id:65,n:"Al Jazeera Mubasher",s:"https://live-hls-apps-ajm-fa.getaj.net/AJM/index.m3u8",c:"news",q:"1080p",src:"Al Jazeera",v:7218,d:"Live events conferences",clr:"#fa9000",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Aljazeera_eng.svg/960px-Aljazeera_eng.svg.png"},
{id:66,n:"France 24 Spanish",s:"https://live.france24.com/hls/live/2037220-b/F24_ES_HI_HLS/master_5000.m3u8",c:"news",q:"1080p",src:"France 24",v:9333,d:"Noticias en espanol",clr:"#0055a5",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f1/France_24_logo_2023.svg/960px-France_24_logo_2023.svg.png"},
{id:67,n:"Africanews",s:"https://d35j504z0x2vu2.cloudfront.net/v1/master/0bc8e8376bd8417a1b6761138aa41c26c7309312/africanews/africanews-en.m3u8",c:"news",q:"720p",src:"Africanews",v:1800,d:"African news English",clr:"#007a3d",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/Africanews_logo.svg/960px-Africanews_logo.svg.png"},
{id:68,n:"America Voice News",s:"https://content.uplynk.com/channel/26bd482ffe364a1282bc3df28bd3c21f.m3u8",c:"news",q:"720p",src:"Uplynk",v:4100,d:"American news",clr:"#b71c1c",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/6/63/ABC_News_Live_logo_2021.svg/960px-ABC_News_Live_logo_2021.svg.png"},
{id:69,n:"ACI Sport TV",s:"https://webstream.multistream.it/memfs/e2cb3629-c1a2-495b-b43a-9eb386f04ed8.m3u8",c:"sports",q:"1080p",src:"Multistream",v:4057,d:"Italian motorsport",clr:"#009688",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/Auto_racing_pictogram.svg/960px-Auto_racing_pictogram.svg.png"},
{id:70,n:"FITE 24/7",s:"https://d3d85c7qkywguj.cloudfront.net/scheduler/scheduleMaster/263.m3u8",c:"sports",q:"1080p",src:"FITE",v:5600,d:"Combat pro wrestling",clr:"#311b92",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/e/e8/FITE_logo.svg/960px-FITE_logo.svg.png"},
{id:71,n:"Sport Italia",s:"https://amg01370-italiansportcom-sportitalia-rakuten-3hmdb.amagi.tv/hls/amagi_hls_data_rakutenAA-sportitalia-rakuten/CDN/master.m3u8",c:"sports",q:"1080p",src:"Rakuten",v:6764,d:"Italian sports",clr:"#00897b",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/0/05/Sportitalia_logo.svg/960px-Sportitalia_logo.svg.png"},
{id:72,n:"Africa 24 Sport",s:"https://africa24.vedge.infomaniak.com/livecast/ik:africa24sport/manifest.m3u8",c:"sports",q:"1080p",src:"Infomaniak",v:2800,d:"African sports",clr:"#007a3d",logo:"https://africa24tv.com/wp-content/uploads/2021/09/logo.png"},
{id:73,n:"Pluto TV Action",s:"https://jmp2.uk/plu-561d7d484dc7c8770484914a.m3u8",c:"movies",q:"720p",src:"Pluto TV",v:9800,d:"Action movies and thrillers 24/7",clr:"#E50914",logo:"https://images.pluto.tv/channels/561d7d484dc7c8770484914a/colorLogoPNG.png"},
{id:74,n:"Pluto TV Drama",s:"https://jmp2.uk/plu-5b4e92e4694c027be6ecece1.m3u8",c:"movies",q:"720p",src:"Pluto TV",v:8500,d:"Drama films around the clock",clr:"#8B0000",logo:"https://images.pluto.tv/channels/5b4e92e4694c027be6ecece1/colorLogoPNG.png"},
{id:75,n:"Pluto TV Crime Drama",s:"https://jmp2.uk/plu-5f4d8594eb979c0007706de7.m3u8",c:"movies",q:"720p",src:"Pluto TV",v:7200,d:"Crime and drama movies",clr:"#2C3E50",logo:"https://images.pluto.tv/channels/5f4d8594eb979c0007706de7/colorLogoPNG.png"},
{id:76,n:"Pluto TV Crime Movies",s:"https://jmp2.uk/plu-5f1210d14ae1f80007bafb1d.m3u8",c:"movies",q:"720p",src:"Pluto TV",v:6800,d:"Crime movies channel",clr:"#1A1A2E",logo:"https://images.pluto.tv/channels/5f1210d14ae1f80007bafb1d/colorLogoPNG.png"},
{id:77,n:"MovieSphere",s:"https://amg00353-lionsgatestudio-moviesphere-xumo-zh5u0.amagi.tv/playlist.m3u8",c:"movies",q:"1080p",src:"Lionsgate/Xumo",v:11200,d:"Lionsgate movies in HD",clr:"#8B008B",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/Lionsgate_logo.svg/960px-Lionsgate_logo.svg.png"},
{id:78,n:"Gravitas Movies",s:"https://d6dg3ebeih71xq.cloudfront.net/Gravitas_Movies.m3u8",c:"movies",q:"1080p",src:"Gravitas",v:5400,d:"Indie and modern films",clr:"#16213E",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Distro_TV_logo.svg/960px-Distro_TV_logo.svg.png"},
{id:79,n:"50 Cent Action",s:"https://jmp2.uk/plu-68487fb3f212bedacf5a53e3.m3u8",c:"movies",q:"720p",src:"Pluto TV",v:7600,d:"Action movies by 50 Cent",clr:"#333333",logo:"https://images.pluto.tv/channels/68487fb3f212bedacf5a53e3/colorLogoPNG.png"},
{id:80,n:"Maverick Black Cinema",s:"https://maverick-maverick-black-cinema-3-us.roku.wurl.tv/playlist.m3u8",c:"movies",q:"1080p",src:"Roku",v:4300,d:"Black cinema and modern films",clr:"#1B1B2F",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Distro_TV_logo.svg/960px-Distro_TV_logo.svg.png"},
{id:81,n:"CINDIE TV",s:"https://d20xuwbyc4yoag.cloudfront.net/v1/master/9d062541f2ff39b5c0f48b743c6411d25f62fc25/DistroTV-MuxIP-CINDIE/387.m3u8",c:"movies",q:"1080p",src:"DistroTV",v:3600,d:"Independent films channel",clr:"#9C27B0",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Distro_TV_logo.svg/960px-Distro_TV_logo.svg.png"},
{id:82,n:"DiscoverFilm",s:"https://discoverfilm-discoverfilm-1-gb.samsung.wurl.tv/playlist.m3u8",c:"movies",q:"720p",src:"Samsung TV+",v:2800,d:"Short films and indie movies",clr:"#00BCD4",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Samsung_TV_Plus_logo.svg/960px-Samsung_TV_Plus_logo.svg.png"},
{id:83,n:"Estrella TV",s:"https://estrellatv-oando.amagi.tv/playlist.m3u8",c:"spanish",q:"1080p",src:"Estrella TV",v:8900,d:"Spanish entertainment network",clr:"#E91E63",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/4/4c/Estrella_TV_logo.svg/960px-Estrella_TV_logo.svg.png"},
{id:84,n:"Estrella News",s:"https://estrella-news-oando.amagi.tv/playlist.m3u8",c:"spanish",q:"1080p",src:"Estrella TV",v:5600,d:"Spanish-language news",clr:"#C62828",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/4/4c/Estrella_TV_logo.svg/960px-Estrella_TV_logo.svg.png"},
{id:85,n:"Cine Comedia",s:"https://jmp2.uk/plu-5f513564e4622a0007c578c0.m3u8",c:"spanish",q:"720p",src:"Pluto TV",v:7400,d:"Spanish comedy movies",clr:"#FF9800",logo:"https://images.pluto.tv/channels/5f513564e4622a0007c578c0/colorLogoPNG.png"},
{id:86,n:"Cine Adrenalina",s:"https://jmp2.uk/plu-5d8d164d92e97a5e107638d2.m3u8",c:"spanish",q:"720p",src:"Pluto TV",v:8100,d:"Spanish action movies",clr:"#F44336",logo:"https://images.pluto.tv/channels/5d8d164d92e97a5e107638d2/colorLogoPNG.png"},
{id:87,n:"Cine Terror",s:"https://jmp2.uk/plu-5d8d180092e97a5e107638d3.m3u8",c:"spanish",q:"720p",src:"Pluto TV",v:4900,d:"Spanish horror movies",clr:"#4A148C",logo:"https://images.pluto.tv/channels/5d8d180092e97a5e107638d3/colorLogoPNG.png"},
{id:88,n:"Cine Premiere",s:"https://jmp2.uk/plu-5cf968040ab7d8f181e6a68b.m3u8",c:"spanish",q:"720p",src:"Pluto TV",v:9300,d:"Spanish movie premieres",clr:"#FFD700",logo:"https://images.pluto.tv/channels/5cf968040ab7d8f181e6a68b/colorLogoPNG.png"},
{id:89,n:"Televisa Telenovelas",s:"https://televisa-televisa-1-it.samsung.wurl.tv/playlist.m3u8",c:"spanish",q:"1080p",src:"Samsung TV+",v:10600,d:"Telenovelas 24/7",clr:"#E91E63",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/TelevisaLogo_2018.svg/960px-TelevisaLogo_2018.svg.png"},
{id:90,n:"Telemundo Florida",s:"https://nbcu-telemundoflorida-firetv.amagi.tv/playlist.m3u8",c:"spanish",q:"1080p",src:"Telemundo",v:9500,d:"Telemundo Florida local",clr:"#1565C0",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/Telemundo_logo_2018.svg/960px-Telemundo_logo_2018.svg.png"},
{id:91,n:"Latino Vibes",s:"https://amg00375-fusemedia-latinovibes-xumo-qyjhw.amagi.tv/playlist.m3u8",c:"spanish",q:"1080p",src:"Xumo",v:6200,d:"Latin music and entertainment",clr:"#FF5722",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Samsung_TV_Plus_logo.svg/960px-Samsung_TV_Plus_logo.svg.png"},
{id:92,n:"Las Estrellas",s:"https://channel01-onlymex.akamaized.net/hls/live/2022749/event01/index.m3u8",c:"spanish",q:"1080p",src:"Televisa",v:13400,d:"Mexico main TV network",clr:"#FFC107",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/TelevisaLogo_2018.svg/960px-TelevisaLogo_2018.svg.png"},
{id:93,n:"Nick Espanol",s:"https://jmp2.uk/plu-5d8d08395f39465da6fb3ec4.m3u8",c:"spanish",q:"720p",src:"Pluto TV",v:5100,d:"Nickelodeon en espanol",clr:"#FF8F00",logo:"https://images.pluto.tv/channels/5d8d08395f39465da6fb3ec4/colorLogoPNG.png"},
{id:94,n:"TV5Monde Info",s:"https://ott.tv5monde.com/Content/HLS/Live/channel(info)/index.m3u8",c:"french",q:"1080p",src:"TV5Monde",v:7800,d:"French world news channel",clr:"#006699",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/TV5Monde_logo_2021.svg/960px-TV5Monde_logo_2021.svg.png"},
{id:95,n:"TV5Monde Style",s:"https://ott.tv5monde.com/Content/HLS/Live/channel(style1)/index.m3u8",c:"french",q:"1080p",src:"TV5Monde",v:4600,d:"French lifestyle and culture",clr:"#880E4F",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/5/5d/TV5Monde_logo_2021.svg/960px-TV5Monde_logo_2021.svg.png"},
{id:96,n:"Euronews Francais",s:"https://2f6c5bf4.wurl.com/master/f36d25e7e52f1ba8d7e56eb859c636563214f541/UmxheHhUVi1ldV9FdXJvbmV3c0ZyYW5jYWlzX0hMUw/playlist.m3u8",c:"french",q:"720p",src:"Euronews",v:5400,d:"European news in French",clr:"#003399",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Euronews_2016.svg/960px-Euronews_2016.svg.png"},
{id:97,n:"BFM TV",s:"https://ncdn-live-bfm.pfd.sfr.net/shls/LIVE$BFM_TV/index.m3u8",c:"french",q:"1080p",src:"BFM",v:11300,d:"France number 1 news channel",clr:"#E53935",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/BFM_TV_logo_2019.svg/960px-BFM_TV_logo_2019.svg.png"},
{id:98,n:"BFM2",s:"https://d1ib1gsg71oarf.cloudfront.net/v1/master/3722c60a815c199d9c0ef36c5b73da68a62b09d1/cc-scp7wda722jph/BFM2_FR.m3u8",c:"french",q:"1080p",src:"BFM",v:3800,d:"French news and documentaries",clr:"#D32F2F",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/b5/BFM_TV_logo_2019.svg/960px-BFM_TV_logo_2019.svg.png"},
{id:99,n:"Africanews Francais",s:"https://cdn-euronews.akamaized.net/live/eds/africanews-fr/25050/index.m3u8",c:"french",q:"720p",src:"Euronews",v:2100,d:"African news in French",clr:"#00897B",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/Africanews_logo.svg/960px-Africanews_logo.svg.png"},
{id:100,n:"ICI RDI",s:"https://rcavlive.akamaized.net/hls/live/704025/xcanrdi/master.m3u8",c:"french",q:"720p",src:"Radio-Canada",v:4200,d:"Canadian French news ICI RDI",clr:"#CE1126",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/ICI_RDI_logo.svg/960px-ICI_RDI_logo.svg.png"},
{id:101,n:"Noovo Cinema",s:"https://dk4ogs46bjxcw.cloudfront.net/v1/master/3722c60a815c199d9c0ef36c5b73da68a62b09d1/cc-xr1ct045l70mz/Noovo_Cinema.m3u8",c:"french",q:"1080p",src:"Noovo Quebec",v:3100,d:"Quebec French movies",clr:"#6A1B9A",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Noovo_logo.svg/960px-Noovo_logo.svg.png"},
{id:102,n:"Noovo Comedies",s:"https://d2s8iafdyzconc.cloudfront.net/v1/master/3722c60a815c199d9c0ef36c5b73da68a62b09d1/cc-6x2p3ho0vw00a/Noovo_Comedies_Home.m3u8",c:"french",q:"1080p",src:"Noovo Quebec",v:2900,d:"Quebec French comedies",clr:"#AD1457",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Noovo_logo.svg/960px-Noovo_logo.svg.png"},
{id:103,n:"Vevo Hip-Hop FR",s:"https://amg00056-amg00056c14-rakuten-fr-3244.playouts.now.amagi.tv/playlist/amg00056-vevotvfast-vevohiphopandrbfr-rakutenfr/playlist.m3u8",c:"french",q:"1080p",src:"Vevo/Rakuten FR",v:4500,d:"Hip-hop RnB music videos FR",clr:"#1B5E20",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Vevo_logo.svg/960px-Vevo_logo.svg.png"},
{id:104,n:"Nickelodeon Pluto",s:"https://jmp2.uk/plu-5ca673e0d0bd6c2689c94ce3.m3u8",c:"kids",q:"720p",src:"Pluto TV",v:10800,d:"Nick cartoons and shows",clr:"#FF6600",logo:"https://images.pluto.tv/channels/5ca673e0d0bd6c2689c94ce3/colorLogoPNG.png"},
{id:105,n:"Nick Teen",s:"https://jmp2.uk/plu-5f0d668b872e4400073acc68.m3u8",c:"kids",q:"720p",src:"Pluto TV",v:4700,d:"Teen Nickelodeon content",clr:"#7B1FA2",logo:"https://images.pluto.tv/channels/5f0d668b872e4400073acc68/colorLogoPNG.png"},
{id:106,n:"HappyKids",s:"https://dil9xdvretp0f.cloudfront.net/index.m3u8",c:"kids",q:"1080p",src:"HappyKids",v:5600,d:"Kids shows and education",clr:"#4CAF50",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Samsung_TV_Plus_logo.svg/960px-Samsung_TV_Plus_logo.svg.png"},
{id:107,n:"Moonbug Kids",s:"https://moonbug-rokuus.amagi.tv/playlist.m3u8",c:"kids",q:"1080p",src:"Moonbug/Roku",v:8200,d:"CoComelon Blippi and more",clr:"#FF9800",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/9/9a/CoComelon_logo.svg/960px-CoComelon_logo.svg.png"},
{id:108,n:"Kartoon Channel",s:"https://lightning-fnf-samsungaus.amagi.tv/playlist.m3u8",c:"kids",q:"1080p",src:"Samsung TV+",v:3400,d:"Cartoons and animated fun",clr:"#2196F3",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/9/9c/Kartoon_Channel_logo.svg/960px-Kartoon_Channel_logo.svg.png"},
{id:109,n:"LEGO Channel",s:"https://jmp2.uk/plu-60fb01a24795a6000762fe83.m3u8",c:"kids",q:"720p",src:"Pluto TV",v:6400,d:"LEGO shows and animations",clr:"#F44336",logo:"https://images.pluto.tv/channels/60fb01a24795a6000762fe83/colorLogoPNG.png"},
{id:110,n:"Garfield and Friends",s:"https://jmp2.uk/plu-60faf9ddfcc1f200070a5932.m3u8",c:"kids",q:"720p",src:"Pluto TV",v:3200,d:"Classic Garfield cartoons",clr:"#FF9800",logo:"https://images.pluto.tv/channels/60faf9ddfcc1f200070a5932/colorLogoPNG.png"},
{id:111,n:"Kidoodle TV",s:"https://amg07653-apmc-amg07653c9-samsung-us-8740.playouts.now.amagi.tv/playlist.m3u8",c:"kids",q:"1080p",src:"Samsung TV+",v:2300,d:"Safe kids streaming",clr:"#03A9F4",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Samsung_TV_Plus_logo.svg/960px-Samsung_TV_Plus_logo.svg.png"},
{id:112,n:"Ryan and Friends",s:"https://ryanandfriends-samsungau.amagi.tv/playlist.m3u8",c:"kids",q:"1080p",src:"Samsung TV+",v:5100,d:"Ryan World toys and games",clr:"#FFC107",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/Samsung_TV_Plus_logo.svg/960px-Samsung_TV_Plus_logo.svg.png"},
{id:113,n:"Pluto TV Kids UK",s:"https://jmp2.uk/plu-5ad8d54be738977e2c310940.m3u8",c:"kids",q:"720p",src:"Pluto TV",v:3800,d:"Kids shows and cartoons UK",clr:"#4DB6AC",logo:"https://images.pluto.tv/channels/5ad8d54be738977e2c310940/colorLogoPNG.png"},
{id:114,n:"Vevo Hip Hop",s:"https://d3vgs3ro3x6v8a.cloudfront.net/Vevo_Hip_Hop.m3u8",c:"music",q:"1080p",src:"Vevo",v:9200,d:"Hip-hop music videos 24/7",clr:"#1DB954",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Vevo_logo.svg/960px-Vevo_logo.svg.png"},
{id:115,n:"Vevo RnB",s:"https://d1hf773q57zx9s.cloudfront.net/Vevo_R_B.m3u8",c:"music",q:"1080p",src:"Vevo",v:7300,d:"RnB music videos",clr:"#7C4DFF",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Vevo_logo.svg/960px-Vevo_logo.svg.png"},
{id:116,n:"Vevo Hip Hop UK",s:"https://d7i20u8nlyf1b.cloudfront.net/VevoHipHopRB_GB.m3u8",c:"music",q:"1080p",src:"Vevo/Samsung",v:4800,d:"Hip-hop and RnB UK edition",clr:"#6200EA",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Vevo_logo.svg/960px-Vevo_logo.svg.png"},
{id:117,n:"AllHipHop",s:"https://stream.ads.ottera.tv/playlist.m3u8?content_livestream=1&network_id=11877",c:"music",q:"720p",src:"Ottera",v:4100,d:"Hip-hop culture and music",clr:"#212121",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Vevo_logo.svg/960px-Vevo_logo.svg.png"},
{id:118,n:"Stingray Urban Beat",s:"https://lotus.stingray.com/manifest/ose-133ads-montreal/samsungtvplus/master.m3u8",c:"music",q:"1080p",src:"Stingray/Samsung",v:6800,d:"Urban hip-hop and RnB hits",clr:"#3F51B5",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/9/98/Stingray_Music_logo.svg/960px-Stingray_Music_logo.svg.png"},
{id:119,n:"Trace Urban",s:"https://lightning-traceurban-samsungau.amagi.tv/playlist.m3u8",c:"music",q:"1080p",src:"Trace/Samsung",v:5400,d:"Urban and hip-hop music",clr:"#FF5722",logo:"https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Trace_TV_logo.svg/960px-Trace_TV_logo.svg.png"},
{id:120,n:"MTV Biggest Pop",s:"https://jmp2.uk/plu-5d14fd1a252d35decbc4080c.m3u8",c:"music",q:"1080p",src:"Pluto TV/MTV",v:8400,d:"Biggest pop and top 40",clr:"#9C27B0",logo:"https://images.pluto.tv/channels/5d14fd1a252d35decbc4080c/colorLogoPNG.png"},
{id:121,n:"Stingray Retro",s:"https://lotus.stingray.com/manifest/ose-109ads-montreal/samsungtvplus/master.m3u8",c:"music",q:"1080p",src:"Stingray/Samsung",v:3600,d:"Retro hits and classics",clr:"#FF4081",logo:"https://upload.wikimedia.org/wikipedia/en/thumb/9/98/Stingray_Music_logo.svg/960px-Stingray_Music_logo.svg.png"}
];
var CATS=[{id:"all",label:"All",icon:"fa-globe"},{id:"news",label:"News",icon:"fa-newspaper"},{id:"sports",label:"Sports",icon:"fa-futbol"},{id:"movies",label:"Movies",icon:"fa-film"},{id:"spanish",label:"Espa\u00f1ol",icon:"fa-flag"},{id:"french",label:"Fran\u00e7ais",icon:"fa-flag"},{id:"entertainment",label:"Entertainment",icon:"fa-star"},{id:"music",label:"Music",icon:"fa-music"},{id:"kids",label:"Kids",icon:"fa-child"},{id:"documentary",label:"Docs",icon:"fa-book"},{id:"international",label:"World",icon:"fa-earth-americas"}];
var CAT_GRAD={news:'linear-gradient(135deg,#1a237e 0%,#0d47a1 50%,#01579b 100%)',sports:'linear-gradient(135deg,#1b5e20 0%,#2e7d32 50%,#388e3c 100%)',movies:'linear-gradient(135deg,#311b92 0%,#4a148c 50%,#6a1b9a 100%)',spanish:'linear-gradient(135deg,#c62828 0%,#d32f2f 50%,#e53935 100%)',french:'linear-gradient(135deg,#0d47a1 0%,#1565c0 50%,#1976d2 100%)',entertainment:'linear-gradient(135deg,#bf360c 0%,#d84315 50%,#e65100 100%)',music:'linear-gradient(135deg,#880e4f 0%,#ad1457 50%,#c2185b 100%)',kids:'linear-gradient(135deg,#e65100 0%,#f57c00 50%,#ff9800 100%)',documentary:'linear-gradient(135deg,#263238 0%,#37474f 50%,#455a64 100%)',international:'linear-gradient(135deg,#004d40 0%,#00695c 50%,#00796b 100%)'};
var CAT_ICON={news:'fa-newspaper',sports:'fa-futbol',movies:'fa-film',spanish:'fa-flag',french:'fa-flag',entertainment:'fa-star',music:'fa-music',kids:'fa-child',documentary:'fa-book-open',international:'fa-earth-americas'};
